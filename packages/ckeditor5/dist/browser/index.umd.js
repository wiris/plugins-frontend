    ...
    */ class ModalDialog {
      ...
      */ constructor(modalDialogAttributes){
        ...
        */ this.websiteBeforeLockParameters = null;
           ...
           console.log(window.btoa(minHoverIcon));
           // Encode the SVG to make it URL-friendly
           const encodedSVG = encodeURIComponent(minHoverIcon).replace(/'/g, "%27").replace(/"/g, "%22");
           // Create the data URL
           ...
           let hoverStyle = `background-size: 10px; background-image: url(data:image/svg+xml;base64,${btoa(minHoverIcon)})`;
           ...
           generalStyle = `background-size: 10px; background-image: url(data:image/svg+xml;base64,${window.btoa(minHoverIcon)})`;
           hoverStyle = `background-size: 10px; background-image: url(data:image/svg+xml;base64,${window.btoa(minHoverIcon)})`;
           ...
           generalStyle = `background-size: 10px; background-repeat: no-repeat; background-image: url(data:image/svg+xml;base64,${window.btoa(minHoverIcon)})`;
      ...
      */ stack() {
           ...
           const generalStyle = `background-size: 10px; background-repeat: no-repeat; background-image: url(data:image/svg+xml;base64,${window.btoa(minHoverIcon)})`;
